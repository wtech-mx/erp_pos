...
-- Tiempo de generación: 17-11-2019 a las 18:16:45
...
--
-- Base de datos: `nwsktjeg_erp_pos`
--
...
--
-- Estructura de tabla para la tabla `adjustments`
--
...
--
-- Estructura de tabla para la tabla `billers`
--
...
--
-- Volcado de datos para la tabla `billers`
--
...
--
-- Estructura de tabla para la tabla `gift_card_recharges`
--
...
--
-- Volcado de datos para la tabla `gift_card_recharges`
--
...
--
-- Estructura de tabla para la tabla `hrm_settings`
--
...
--
-- Volcado de datos para la tabla `hrm_settings`
--
...
(1, 'es', '2018-07-07 22:59:17', '2019-11-18 10:15:15');
...
--
-- Estructura de tabla para la tabla `payment_with_cheque`
--
...
--
-- Volcado de datos para la tabla `payment_with_cheque`
--
...
--
-- Estructura de tabla para la tabla `payment_with_credit_card`
--
...
--
-- Estructura de tabla para la tabla `payment_with_gift_card`
--
...
--
-- Volcado de datos para la tabla `payment_with_gift_card`
--
...
--
-- Estructura de tabla para la tabla `payment_with_paypal`
--
...
--
-- Estructura de tabla para la tabla `pos_setting`
--
...
--
-- Volcado de datos para la tabla `pos_setting`
--
...
--
-- Estructura de tabla para la tabla `product_adjustments`
--
...
--
-- Estructura de tabla para la tabla `product_returns`
--
...
--
-- Volcado de datos para la tabla `product_returns`
--
...
--
-- Volcado de datos para la tabla `product_transfer`
--
...
--
-- Estructura de tabla para la tabla `purchase_product_return`
--
...
--
-- Volcado de datos para la tabla `purchase_product_return`
--
...
--
-- Volcado de datos para la tabla `return_purchases`
--
...
--
-- Indices de la tabla `adjustments`
--
...
--
-- Indices de la tabla `gift_card_recharges`
--
...
--
-- Indices de la tabla `hrm_settings`
--
...
--
-- Indices de la tabla `payment_with_cheque`
--
ALTER TABLE `payment_with_cheque`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `payment_with_credit_card`
--
ALTER TABLE `payment_with_credit_card`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `payment_with_gift_card`
--
ALTER TABLE `payment_with_gift_card`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `payment_with_paypal`
--
...
--
-- Indices de la tabla `pos_setting`
--
...
--
-- Indices de la tabla `product_adjustments`
--
...
--
-- Indices de la tabla `product_returns`
--
...
--
-- Indices de la tabla `purchase_product_return`
--
...
--
-- AUTO_INCREMENT de la tabla `adjustments`
--
ALTER TABLE `adjustments`
...
--
-- AUTO_INCREMENT de la tabla `billers`
--
ALTER TABLE `billers`
...
--
-- AUTO_INCREMENT de la tabla `gift_card_recharges`
--
ALTER TABLE `gift_card_recharges`
...
--
-- AUTO_INCREMENT de la tabla `hrm_settings`
--
ALTER TABLE `hrm_settings`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `payment_with_cheque`
--
ALTER TABLE `payment_with_cheque`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `payment_with_credit_card`
--
ALTER TABLE `payment_with_credit_card`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `payment_with_gift_card`
--
ALTER TABLE `payment_with_gift_card`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `payment_with_paypal`
--
ALTER TABLE `payment_with_paypal`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `product_adjustments`
--
ALTER TABLE `product_adjustments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `product_returns`
--
ALTER TABLE `product_returns`
...
--
-- AUTO_INCREMENT de la tabla `purchase_product_return`
--
ALTER TABLE `purchase_product_return`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
