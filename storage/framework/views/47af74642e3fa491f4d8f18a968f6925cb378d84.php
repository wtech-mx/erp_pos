    ...
    <div class="page login-page">
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
         ...
         <h1>ERP_POS sistema ERP CONTABILIDAD POS Y RECURSOS HUMANOS</h1>
          ...
          <div class="copyrights text-center">
            <p><?php echo e(trans('file.Developed By')); ?> <a href="https://ventas.programacionparacompartir.com/" class="external">ventas.programacionparacompartir</a></p>
          </div>
        </div>
      </div>
    </div>
